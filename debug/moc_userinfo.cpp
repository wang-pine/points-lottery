...
#include <memory>
#include "../../GambleSystem/userinfo.h"
...
QT_MOC_LITERAL(1, 9, 14), // "addONE_clicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14) // "addTEN_clicked"

    },
    "UserInfo\0addONE_clicked\0\0addTEN_clicked"
};
...
void UserInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addONE_clicked(); break;
        case 1: _t->addTEN_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserInfo::addONE_clicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UserInfo::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserInfo::addTEN_clicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UserInfo::addONE_clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void UserInfo::addTEN_clicked()
{
